    ...
    app.post("/api/friends", function (req, res) {
        ...
        friendData.forEach(function (friend) {
            ...
            scoresArray.forEach(function (score, index) {
                ...
                differenceSum += Math.abs(newFriend.survey[index] - score); // Take the absolute value of each difference before adding them all together so there are no negative solutions
            })
        ...
        // Send the friendMatch object back as a JSON response
